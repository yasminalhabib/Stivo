...
struct WorkView: View {
    ...
    var body: some View {
            ...
            ZStack(alignment: .top) {
                ...
                ScrollView {
                    VStack(alignment: .leading, spacing: 10) {
                        ...
                        if viewModel.workGoals.isEmpty {
                            emptyStateView
                        } else {
        ...
        .sheet(isPresented: $showAddGoal) {
            AddGoal(goals: $viewModel.workGoals, showSheet: $showAddGoal, editingGoal: $selectedGoal)
    ...
    func goalSection(title: String, frequency: Frequency) -> some View {
        let filtered = $viewModel.workGoals.filter { $0.wrappedValue.frequency == frequency }
        if !filtered.isEmpty {
